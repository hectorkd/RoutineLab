...
const SavedRoutineDisplay: React.FC<CreateRoutineProps> = ({ route }) => {
  ...
  function flatListHeader(): JSX.Element {
    return <View style={styles.vaultList}></View>;
  }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.middle}>
        <FlatList
          ...
          scrollEnabled={false}
          ListHeaderComponent={
            apparatus === "Vault" ? flatListHeader : flatListSeperator
          }
        />
      </View>
            ...
            <View style={styles.routineAdditionDisplay}>
              ...
              <View style={[styles.additionBox, styles.colorThree]}>
                <Text style={styles.textBold}>
                  {startValue[0].elementTotal}
                </Text>
              </View>
            </View>
            <View style={styles.vaultRoutineAdditionDisplay}>
              <Text style={[styles.totalValueNum, styles.colorFour]}>
                FIRST VAULT START:{" "}
              </Text>
              <Text style={styles.totalValueNum}>
                {startValue[0].totalStartValue}
              </Text>
            </View>
