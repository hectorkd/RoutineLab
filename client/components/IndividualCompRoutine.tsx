...
interface IndividualCompRoutineProps { savedRoutine: IPostRoutine, navigation: any }

const IndividualCompRoutine: React.FC<IndividualCompRoutineProps> = ({ savedRoutine, navigation }) => {
...
export default IndividualCompRoutine;